...
URL1 = 'https://www.loopnet.com/search/industrial-properties/los-angeles-ca/for-sale/?sk=386b4cc60cf2318989aad7d8be7d5d4c&bb=k-w4sqn-qNjs2-613D'
...
# properties = soup1.find_all(class_ = 'header-col')
...
def loop_through_properties(soup):
    ...
    write_to_file(records)
        # print(propert, price, lot_size, price_per_sf, rentable_building_area)
